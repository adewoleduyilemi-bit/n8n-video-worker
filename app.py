...
# Configuration
UPLOAD_FOLDER = '/var/www/html/downloads'
...
def adjust_audio_speed(audio_path, speed, output_path):
    ...
    try:
        ...
        # Use multiple filters if needed
        cmd = [
            'ffmpeg', '-i', audio_path,
            '-af', f'atempo={speed}',
            '-y', output_path
...
def process_variant():
    ...
    try:
        ...
        output_file = os.path.join(UPLOAD_FOLDER, f'{workflow_id}_{variant_name}.mp4')
        ...
        # Build download URL (adjust domain as needed)
        download_url = f"https://yourdomain.com/downloads/{workflow_id}_{variant_name}.mp4"
